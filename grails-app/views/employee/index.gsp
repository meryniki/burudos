									...
									<div id="DataTables_Table_1_wrapper"
										...
										<div class="row">
												...
												<div id="DataTables_Table_1_length"
													...
													<label> Lineas por pagina<span>
															<div class="selector" style="width: 25% !important;">
																<span style="-webkit-user-select: none;">20</span>
											...
											<div class="col-lg-4">
												<div class="dataTables_filter"
													...
													<label> <span
											class="icon16 icomoon-icon-search"></span> <input style="width: 75%;" type="text"
										...
										<div class="row">
											<div class="col-lg-4">
												...
												<ul class="pagination">
													<li><g:paginate total="${employeeInstanceCount ?: 0}"/></li>
												</ul>	
												</div>
											</div>
										</div>
