		...
		<div id="list-subcontractor" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="dofbeg" title="${message(code: 'subcontractor.dofbeg.label', default: 'Dofbeg')}" />
				...
				<g:each in="${subcontractorInstanceList}" status="i" var="subcontractorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${subcontractorInstance.id}">${fieldValue(bean: subcontractorInstance, field: "uid")}</g:link></td>
						...
						<td>${fieldValue(bean: subcontractorInstance, field: "bu")}</td>
