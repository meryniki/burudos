...
<title><g:message code="parameter.create.label"
	...
	<div id="content" class="clearfix">
		<div class="contentwrapper">
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div id="create-parameter" class="content scaffold-create"
						role="main">
						<h1>
							<g:message code="parameter.create.label" args="[entityName]" />
						</h1>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4>
									<span><g:message code="parameter.create.heading" /></span>
								</h4>
							</div>
							<div class="panel-body">
								<g:form url="[resource:parameterInstance, action:'save']"
									...
									<fieldset>
										<div class="form-group">
											<div class="col-lg-offset-3 col-lg-9">
												<g:submitButton name="create" class="btn btn-info save"
