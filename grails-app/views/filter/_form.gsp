...
<div
	...
	<div class="col-lg-9">
		<g:textField name="description" value="${filterInstance?.description}" />
	</div>
</div>
...
<div
	...
	<label class="col-lg-3 control-label" for="bu"> <g:message
			code="filter.bu.label" default="Bu" /> <span
...
<div
	...
	<label class="col-lg-3 control-label" for="op"> <g:message
			code="filter.op.label" default="Op" />
...
<div
	...
	<label class="col-lg-3 control-label" for="month"> <g:message
			code="filter.month.label" default="Month" /> <span
		class="required-indicator">*</span>
	</label>
	<div class="col-lg-9">
