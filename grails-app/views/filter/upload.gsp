		...
		<div class="contentwrapper">
			<div class="heading">
				...
				<ul class="breadcrumb">
					...
					<li class="active"><g:message code="employee.upload.label"
							args="[entityName]" /></li>
				</ul>
			...
			<div id="#upload-employee" class="content scaffold-create"
				role="main">
				<h1>
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									<div class="uploader" id="uniform-file">
										<input type="file" class="form-control" name="FileFilter"
