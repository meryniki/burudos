...
<html>
	...
	<body>
		<a href="#edit-summary" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-summary" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:summaryInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${summaryInstance?.version}" />
				<fieldset class="form">
