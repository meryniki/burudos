...
<html>
	...
	<body>
		<a href="#edit-operation" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-operation" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:operationInstance, action:'update']" method="PUT" >
