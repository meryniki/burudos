						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="row statement-group">
									<div class="page-header">
										<h4>
											<span class="icon16 icomoon-icon-office"></span>Desempeño del
											punto de venta
										</h4>
									</div>
												...
												<h4>
													...
													<form class="panel-form right" action="">
														...
														<ul class="dropdown-menu">
															<li><a href="#"><span class="icomoon-icon-plus"></span>
																	Agregar</a></li>
														</ul>
													</form>
														...
														<tbody>
															<tr>
																...
																<td>
																	<div class="controls center">
																		<a href="#" class="tip" oldtitle="Edit task" title=""
																			data-hasqtip="true"><span
																			class="icon12 icomoon-icon-pencil"></span></a> <a
																			href="#" class="tip" oldtitle="Remove task" title=""
																			data-hasqtip="true"><span
															...
															<tr>
																...
																<td>
																	<div class="controls center">
																		<a href="#" class="tip" oldtitle="Edit task" title=""
																			data-hasqtip="true" aria-describedby="qtip-17"><span
																			class="icon12 icomoon-icon-pencil"></span></a> <a
																			href="#" class="tip" oldtitle="Remove task" title=""
																			data-hasqtip="true" aria-describedby="qtip-18"><span
																			class="icon12 icomoon-icon-remove"></span></a>
																	</div>
																</td>
															</tr>
					...
					<ul>
						...
						<li class="fieldcontain"><span id="pointsSubtotal-label"
							class="property-label"><g:message
									code="statement.pointsSubtotal.label" default="Points Subtotal" /></span>
							<span class="property-value"
							aria-labelledby="pointsSubtotal-label"></span></li>

						<li class="fieldcontain"><span id="stalesSubtotal-label"
							class="property-label"><g:message
									code="statement.stalesSubtotal.label" default="Stales Subtotal" /></span>
							<span class="property-value"
						...
						<li class="fieldcontain"><span id="othersSubtotal-label"
							class="property-label"><g:message
									code="statement.othersSubtotal.label" default="Others Subtotal" /></span>
							<span class="property-value"
